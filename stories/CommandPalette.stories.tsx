import CommandPalette, { JsonStructure, filterItems, renderJsonStructure, useHandleOpenCommandPalette } from '../src'
	...
	const items: JsonStructure = [
		...
		},
		{
			...
			items: [
				{
					children: 'Home',
					icon: <LifebuoyIcon className='w-5 h-5 text-gray-500' />,
					id: 'home',
					disabled: true,
					href: '#',
...
function Welcome() {
	return (
		<div className='w-full rounded-lg bg-gradient-to-br from-indigo-900 via-indigo-800 to-indigo-400 p-4 border-t border-indigo-500 border-b border-indigo-500'>
			<h2 className='text-lg font-semibold leading-tight text-white'>Welcome 👋</h2>
